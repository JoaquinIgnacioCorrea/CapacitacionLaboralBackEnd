...
namespace PracticaJson
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string pathEjercicioUno = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "persona.json");
            string pathEjercicioDos = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "usuario-con-amigos.json");
            string pathEjercicioTres = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "estadisticas-partida.json");
            string pathEjercicioCuatro = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "catalogo-productos.json");
            #endregion
