...
[Ver Ejercicio SQL](./03-EjercicioSql/EjercicioSQL.sql)
...
- [Consultas SQL](./03-EjercicioSql/EjercicioSQL.sql)
...
Los archivos `data.txt` se copian automaticamente al directorio de salida de sus respectivos proyectos, por lo que ya no dependen de una ruta especifica de Windows ni de la carpeta donde se clone el repositorio.
